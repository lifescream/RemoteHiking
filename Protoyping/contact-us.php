						...
						<div class="user-links">
							<div class="login">
								...
								<form id="login-form" class="login-form">
									...
									<input class="button-2-green" type="submit" value="Login">
								</form>
							</div>
							<div class="register">
						...
						<div class="contact-us block">
							...
							<div class="comment-message">
								<div class="comment-message-title">
									Send Us a <span class="text-green">Message</span>
								</div>
								<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="contact-us-form" class="comment-message-form">
									...
									<input type="submit" name="submit" value="Send Message" class="button-2-green" />
									<?php if(isset($hasError)) { //If errors are found ?>
										<div class="form-message text-green">Please check if you've filled all the fields with valid information. Thank you.</div>
									<?php } ?>
									<?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
										<div class="form-message text-green">Thank you! Email successfully sent.</div>
									<?php } ?>
								</form>
							</div>
						</div>
						...
						<div class="company-details block">
							<div class="company-address">
								...
								<div class="detail email">
									E-mail: <a href="mailto:email@example.com" class="text-green">email@example.com</a><br />Website: <a href="http://themeforest.net/" class="text-green">www.example.com</a>
								</div>
							</div>
